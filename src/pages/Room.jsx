...
export function Room () {
    ...
    async function handleLikeQuestion (questionKey, likeId) {
        if(likeId){
            await remove(ref(db, `/rooms/${roomId}/questions/${questionKey}/likes/${likeId}`))
        } else{
            await push(ref(db, `/rooms/${roomId}/questions/${questionKey}/likes`), { authorId: user.id})
